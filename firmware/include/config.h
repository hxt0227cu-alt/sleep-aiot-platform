...
#define GSM_PWR_PIN                 GPIO_NUM_6  ///< GSM电源控制引脚
#define GSM_RST_PIN                 GPIO_NUM_7  ///< GSM复位引脚
...
#define ADC_MUSIC_PIN               GPIO_NUM_4  ///< ADC_MUSIC, reused as color temperature, netlist U1.4
...
// 引脚定义 - 负离子发生器
//=============================================================================
#define ANION_PWR_PIN               GPIO_NUM_11 ///< 负离子电源控制引脚
...
// MQTT配置
//=============================================================================
#define MQTT_BROKER_HOST            "taiyizhi.com"      ///< MQTT服务器地址
...
#define TASK_STACK_SIZE_MQTT        8192        ///< MQTT任务堆栈大小
...
// OTA升级配置
//=============================================================================
#define OTA_SERVER_URL              "https://taiyizhi.com/ota/firmware"       ///< OTA服务器地址
