 ...
 */
typedef enum {
    WIFI_EVENT_NONE = 0,            ///< 无事件
    WIFI_EVENT_CONNECTED,           ///< 已连接
    WIFI_EVENT_DISCONNECTED,        ///< 已断开
    WIFI_EVENT_GOT_IP,              ///< 获取IP
    WIFI_EVENT_LOST_IP,             ///< 丢失IP
    WIFI_EVENT_SMARTCONFIG_DONE,  ///< SmartConfig完成
    WIFI_EVENT_SMARTCONFIG_TIMEOUT  ///< SmartConfig超时
} wifi_event_t;
