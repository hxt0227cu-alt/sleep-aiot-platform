...
#define MQTT_TASK_STACK_SIZE    6144    ///< ESP-MQTT内部任务堆栈大小
 ...
 */
typedef enum {
    MQTT_CLIENT_EVENT_CONNECTED = 0,       ///< 已连接
    MQTT_CLIENT_EVENT_DISCONNECTED,        ///< 已断开
    MQTT_CLIENT_EVENT_MESSAGE,             ///< 收到消息
    MQTT_CLIENT_EVENT_PUBLISHED,           ///< 消息已发布
    MQTT_CLIENT_EVENT_ERROR                ///< 发生错误
} mqtt_event_t;
